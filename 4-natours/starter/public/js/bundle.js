...
var stripe = Stripe("pk_test_51GxYQMFFq7aGE20rH8KaDKOFhUHULHU4Fc9xzghIx35hBtf1t1B93IE54aFAYC9vRoVWzNrqIt3qx6cPvcltDGOj00lonU9f5v");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2. membuat form checkout + proses penarikan kartu credit
...
var bookBtn = document.querySelector("#book-tour"); // Tombol logout
